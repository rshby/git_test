...
const (
	CustomerService_CreateCustomer_FullMethodName     = "/git_test.proto.CustomerService/CreateCustomer"
	CustomerService_GetCustomerByEmail_FullMethodName = "/git_test.proto.CustomerService/GetCustomerByEmail"
	CustomerService_GetCustomerByID_FullMethodName    = "/git_test.proto.CustomerService/GetCustomerByID"
)
...
func (c *customerServiceClient) GetCustomerByEmail(ctx context.Context, in *GetCustomerByEmailRequest, opts ...grpc.CallOption) (*GetCustomerByEmailResponse, error) {
	...
	err := c.cc.Invoke(ctx, CustomerService_GetCustomerByEmail_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _CustomerService_GetCustomerByEmail_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: CustomerService_GetCustomerByEmail_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
var CustomerService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "git_test.proto.CustomerService",
